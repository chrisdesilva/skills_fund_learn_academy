...
export const leadContent = {
	...
	paragraph: `${schoolName} designs its programs to prepare students for a career in web development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
