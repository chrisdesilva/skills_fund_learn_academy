...
export const leadContent = {
  ...
  paragraph: `${schoolName} designs its programs to prepare students for a career in web development. ${schoolName} partners with Skills Fund to offer tuition${
...
export const threeStepCardText = {
  ...
  step2: {
    ...
    text:
      "Learn Academy focuses exclusively on its Full-Time Immersive program.",
  },
...
export const programLoanInfo = [
  // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
  {
    ...
    url: "https://my.skills.fund/application?lenderCode=SFL17",
    loanInfo: {
      ...
      "Immediate Repaymant": null, // immediate repayment
    },
...
export const programMaxText =
  "Choose the loan amount that works best for you. Borrow up to $14,000 for tuition & $6,000 for cost of living."
