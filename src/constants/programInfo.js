import logo from "../images/logo_learn.svg" // add school logo to images folder and import here
...
export const schoolName = "Learn Academy"

export const schoolURL = 'https://www.learnacademy.org/' // update with url of school's website

export const skfURL = 'https://learn.skills.fund' // update with Skills Fund url

export const headline = "Code at Learn Academy" // update headline as appropriate

export const leadContent = {
    header: "Your last step on the path toward changing your career",
    paragraph: `${schoolName} designs its programs to prepare students for a career in web development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const threeStepCardText = {
    ...
    step2: {
        ...
        text: "Learn Academy focuses exclusively on its Full-Time Immersive program."
    },
    step3: `You'll be on your way to an exciting career in tech as part of ${schoolName}'s powerful network.`
}

export const netlifyFormName = 'learnacademy_contact'

export const GATracking = 'UA-68312423-1'

export const hubspotFormId = "f2f8923b-60f6-4f29-99ab-2cecb5e2a9ff" // create Hubspot form, get form id after publishing
...
export const programLoanInfo = [ // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
    {
        name: "Full-Time Immersive Program",
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SFL17",
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to $14,000 for tuition & $6,000 for cost of living."
